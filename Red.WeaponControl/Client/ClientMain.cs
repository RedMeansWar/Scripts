        ...
        private async Task ShowCurrentModeTick()
        {
            ...
            if (weapon != WeaponHash.StunGun && weapon != (WeaponHash)Game.GenerateHashASCII("WEAPON_PROLASER4"))
            {
                ...
                else if (IsWeaponAutomatic(weapon))
                {
                    ...
                    {
                        case 1:
                            DrawText2d(0.205f, 2.25f, 0.37f, "BURST", 250, 250, 120);
                            break;
                        case 2:
                            DrawText2d(0.205f, 2.25f, 0.37f, "SINGLE", 250, 250, 120);
                            break;
                        default:
                            DrawText2d(0.205f, 2.25f, 0.37f, "AUTO", 250, 250, 120);
                            break;
                    }
                }

                DrawSprite("mpweaponsgang0", "w_ar_carbinerifle_mag1", (1 / GetSafeZoneSize() / 3.0f) - 0.358f + 0.20f, GetSafeZoneSize() - GetTextScaleHeight(1.6f, 4) - 0.036f, 0.099f, 0.099f, 0.0f, 200, 200, 200, 255);
            }
            else
            {
                DrawText2d(0.205f, 2.25f, 0.37f, weaponsWithSafetyEnabled.Contains(weapon.Hash) ? "~r~X" : $" {taserCartridges}", 250, 250, 120);
                DrawSprite("mpweaponsgang0", "w_pi_stungun", (1 / GetSafeZoneSize() / 3.0f) - 0.358f + 0.19f, GetSafeZoneSize() - GetTextScaleHeight(1.3f, 4) - 0.036f, 0.034f, 0.034f, 0.0f, 200, 200, 200, 255);
            }
